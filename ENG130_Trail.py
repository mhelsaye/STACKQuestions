...
# #     try:
# #         user = float(user)
# #         return abs(user - correct) / correct < tol
...
# #     # 🌐 Initial load
# #     if button_id == 'url':
# #         return '', '', '', generate_problem(), None, None, None, False, False, ''
...
# #         if status == "draft":
# #             restored_problem = {
# #                 "F1": int(latest.get("F1", 0)),
# #                 "F2": int(latest.get("F2", 0)),
# #                 "F3": int(latest.get("F3", 0)),
# #                 "Ans1": to_float(latest.get("Ans1")),
# #                 "Ans2": to_float(latest.get("Ans2")),
# #                 "Ans3": to_float(latest.get("Ans3")),
# #             }
# #             return (
# #                 '', '', '', restored_problem,
# #                 to_float(latest.get("Ans1")),
# #                 to_float(latest.get("Ans2")),
# #                 to_float(latest.get("Ans3")),
# #                 False, False,
...
# #         a1_val = safe_float(a1)
# #         a2_val = safe_float(a2)
# #         a3_val = safe_float(a3)

# #         # Validate input values (entered by student)
# #         if not all(isinstance(x, (int, float)) for x in [a1_val, a2_val, a3_val]):
# #             return (
...
# #         return f1, f2, f3, dash.no_update, a1, a2, a3, True, True, ""
...
# #                 to_clean_float(a1), to_clean_float(a2), to_clean_float(a3),
# #                 0,  # score
# #                 "draft"
# #             )
# #     return "Saved!"
...
#             try:
#                 # Create problem data with the stored values
#                 restored_problem = {
#                     "F1": int(float(latest.get("F1", 0))),
#                     "F2": int(float(latest.get("F2", 0))),
#                     "F3": int(float(latest.get("F3", 0))),
#                     "Ans1": to_float(latest.get("Ans1", 0)),
#                     "Ans2": to_float(latest.get("Ans2", 0)),
#                     "Ans3": to_float(latest.get("Ans3", 0)),
#                 }
...
#         print("🧪 Converted inputs:", a1_val, a2_val, a3_val)
#         print("🧪 Raw inputs:", a1, a2, a3)

        
#         if any(x in [None, ""] for x in [a1, a2, a3]) or any(v is None for v in [a1_val, a2_val, a3_val]):
#             return (
#                 "⚠️ Please complete all fields.",
#                 "", "", dash.no_update,
#                 a1, a2, a3,
